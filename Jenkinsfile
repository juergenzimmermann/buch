    ...
    stages {
        ...
        stage('Install') {
            steps {
                ...
                // https://computingforgeeks.com/how-to-install-python-on-debian-linux
                // sh 'apt-get install --no-install-recommends --yes --show-progress gcc=4:12.2.0-3 g++=4:12.2.0-3 make=4.3-4.1 python3.11-minimal=3.11.2-1+b1'
                sh 'apt-get install --no-install-recommends --yes --show-progress gcc=4:12.2.0-3 g++=4:12.2.0-3 make=4.3-4.1 python3.11-minimal'
